...
class TestDashBoard(unittest.TestCase):
    ...
    """
            method to enable signup or register
    """
    def test_signup_is_successful(self):
        self.assertEqual(len(self.dashboard.registry), 0)
        self.assertTrue(self.dashboard.signup("testing tester",
                                              "tester@gmail.com", "testersPassword"))
    ...
    def test_login_fails_if_email_is_not_registered(self):
        self.assertFalse(self.dashboard.login(
            "tester@gmail.com", "testersPassword"))
